  ...
  <div class="create-post">
      ...
      <div class="container">
          ...
          <div class="blog-actions">
              <button @click="updateBlog" id="router-button">Save Changes</button>
              <router-link :to="{name: 'BlogPreview'}" id="router-button" class="router-button">Preview Changes</router-link>
          </div>
      </div>
  </div>
</template>
